...
const BASE_SUBJECTS_DATA: SubjectItem[] = [
  ...
  },
  {
    ...
    "activeLessonsCount": "3/7",
    "themes": [
      {
        "id": "english_foundations",
        "number": 1,
        "title": "Foundations: Grammar & Vocabulary",
        "description": "Greetings, verb to be, simple present, numbers and everyday conversation (10-13 years)",
        "level": "basico",
        "ageGroup": "10-13 anos",
        "lessons": [
          {
            ...
            "subjectId": "ingles",
            "themeNumber": 1,
            "title": "Inglês do Zero: Pronomes e o Verbo To Be",
            "subtitle": "Primeiros Passos e Apresentação Pessoal",
            "summary": "Aprenda a se apresentar e falar sobre si mesmo passo a passo com explicações claras em português.",
            "content": {
              "questionPrompt": "Como começar a aprender inglês do zero?",
              "description": "Para quem está a começar, o primeiro passo é conhecer os pronomes pessoais e o verbo 'To Be'. Em português, esse verbo significa tanto 'SER' quanto 'ESTAR'. Vamos aprender como usá-lo com tranquilidade!",
              "numeratorExplanation": "Pronomes Pessoais: I significa eu. You significa você. He significa ele. She significa ela. We significa nós. They significa eles ou elas.",
              "denominatorExplanation": "O Verbo To Be na prática: 'I am' significa Eu sou ou Eu estou. 'You are' significa Você é ou Você está. 'He is' significa Ele é ou Ele está. 'She is' significa Ela é ou Ela está.",
              "exampleText": "Exemplo prático: 'Hello! My name is Pablo. I am very happy.' significa Olá! O meu nome é Pablo. Eu estou muito feliz.",
              "dailyLifeContext": "Ao jogar videogames, ouvir músicas e navegar na internet, você vai reconhecer essas palavrinhas todos os dias!"
            },
            "level": "basico",
            "exercises": [
              {
                ...
                "questionNumber": 1,
                "totalQuestions": 10,
                "prompt": "Como se completa a frase: 'I _____ very happy today!'?",
                "options": [
                  {
                    "id": "a",
                    "text": "is"
                ...
                "correctOptionId": "b",
                "explanation": "Com o pronome 'I', usamos 'am' (I am)."
              },
              {
                "id": "i1_2",
                "lessonId": "ing_base",
                "questionNumber": 2,
                "totalQuestions": 10,
                "prompt": "Qual é a tradução correta para 'Good afternoon'?",
                "options": [
                  {
                    "id": "a",
                    "text": "Bom dia"
                ...
                "correctOptionId": "b",
                "explanation": "Good afternoon = Boa tarde."
              },
              {
                "id": "i1_3",
                "lessonId": "ing_base",
                "questionNumber": 3,
                "totalQuestions": 10,
                "prompt": "Qual é a cor 'Yellow' em português?",
                "options": [
                  {
                    "id": "a",
                    "text": "Azul"
              ...
              },
              {
                ...
                "questionNumber": 4,
                "totalQuestions": 10,
                "prompt": "Qual das palavras significa 'Livro' em inglês?",
                "options": [
                  {
                    "id": "a",
                    "text": "Pencil"
              ...
              },
              {
                ...
                "questionNumber": 5,
                "totalQuestions": 10,
                "prompt": "Como se diz o número 12 em inglês?",
                "options": [
                  {
                    "id": "a",
                    "text": "Ten"
              ...
              },
              {
                ...
                "questionNumber": 6,
                "totalQuestions": 10,
                "prompt": "Complete: 'They _____ playing soccer in the park.'",
                "options": [
                  {
                    "id": "a",
                    "text": "is"
                ...
                "correctOptionId": "b",
                "explanation": "Para o plural 'They', usamos 'are'."
              },
              {
                "id": "i1_7",
                "lessonId": "ing_base",
                "questionNumber": 7,
                "totalQuestions": 10,
                "prompt": "Qual o significado da pergunta: 'Where are you from?'?",
                "options": [
                  {
                    "id": "a",
                    "text": "Como te chamas?"
                ...
                "correctOptionId": "b",
                "explanation": "'Where are you from?' pergunta a nacionalidade ou cidade de origem."
              },
              {
                "id": "i1_8",
                "lessonId": "ing_base",
                "questionNumber": 8,
                "totalQuestions": 10,
                "prompt": "Qual é o oposto de 'Big' (Grande)?",
                "options": [
                  {
                    "id": "a",
                    "text": "Tall"
                ...
                "correctOptionId": "b",
                "explanation": "Small significa pequeno."
              },
              {
                "id": "i1_9",
                "lessonId": "ing_base",
                "questionNumber": 9,
                "totalQuestions": 10,
                "prompt": "Qual é o dia da semana que vem depois de 'Monday' (Segunda-feira)?",
                "options": [
                  {
                    "id": "a",
                    "text": "Sunday"
                ...
                "correctOptionId": "b",
                "explanation": "Tuesday = Terça-feira."
              },
              {
                "id": "i1_10",
                "lessonId": "ing_base",
                "questionNumber": 10,
                "totalQuestions": 10,
                "prompt": "Como se responde educadamente a 'Thank you'?",
                "options": [
                  {
                    "id": "a",
                  ...
                  {
                    "id": "d",
                    "text": "No problem never!"
                  }
                ],
                "correctOptionId": "a",
                "explanation": "'You are welcome' é o equivalente cordial a 'De nada'!"
              }
            ]
          }
        ]
      },
      {
        "id": "english_advanced",
        "number": 2,
        "title": "Advanced English: Reading & Debate",
        "description": "Past tenses, conditionals, phrasal verbs, idioms and global communication (14-17 years)",
        "level": "avancado",
        "ageGroup": "14-17 anos",
        "lessons": [
          {
            ...
            "subjectId": "ingles",
            "themeNumber": 2,
            "title": "Fluency: Idioms, Conditionals & Debate",
            "subtitle": "Expressing Complex Ideas and Nuances",
            "summary": "Master phrasal verbs, second conditional and text interpretation.",
            "content": {
              "questionPrompt": "How to express hypothetical situations?",
              "description": "The Second Conditional is used to talk about imaginary or unlikely situations in the present or future: 'If I had a spaceship, I would travel to Mars.'",
              "numeratorExplanation": "Structure: If + Past Simple, ... would + infinitive verb.",
              "denominatorExplanation": "Phrasal Verbs: verbs combined with prepositions that change meaning (e.g. Give up = desistir, Look forward to = aguardar com entusiasmo).",
              "exampleText": "'If everyone had access to free education, the world would be much more peaceful.'",
              "dailyLifeContext": "University scholarships, international careers, tech internships and scientific papers demand advanced English."
            },
            "level": "avancado",
            "exercises": [
              {
                ...
                "questionNumber": 1,
                "totalQuestions": 10,
                "prompt": "Complete the sentence: 'If I won a million dollars, I _____ travel around the world.'",
                "options": [
                  {
                    "id": "a",
                    "text": "will"
              ...
              },
              {
                ...
                "questionNumber": 2,
                "totalQuestions": 10,
                "prompt": "What is the meaning of the phrasal verb 'Give up'?",
                "options": [
                  {
                    "id": "a",
                  ...
                  {
                    "id": "b",
                    "text": "Desistir / render-se"
                  },
                  {
                    "id": "c",
                    "text": "Presentear alguém"
                  },
                  {
                    "id": "d",
                    "text": "Levantar-se"
                ...
                "correctOptionId": "b",
                "explanation": "'Give up' significa desistir ou abandonar."
              },
              {
                "id": "i2_3",
                "lessonId": "ing_adv",
                "questionNumber": 3,
                "totalQuestions": 10,
                "prompt": "Choose the correct sentence in the Present Perfect tense:",
                "options": [
                  {
                    "id": "a",
                  ...
                  {
                    "id": "b",
                    "text": "I visit London yesterday."
                  },
                  {
                    "id": "c",
                    "text": "I was visit London."
                  },
                  {
                    "id": "d",
                    "text": "I am visiting London last year."
                  }
                ],
                "correctOptionId": "a",
                "explanation": "'Have visited' conecta uma experiência do passado ao presente sem data definida."
              },
              {
                "id": "i2_4",
                "lessonId": "ing_adv",
                ...
                "options": [
                  {
                    "id": "a",
                    "text": "Um bolo de chocolate"
                  },
                  {
                    "id": "b",
                    "text": "Algo muito fácil de fazer"
                  },
                  {
                    "id": "c",
                    "text": "Um problema complicado"
                  },
                  {
                    "id": "d",
                    "text": "Uma refeição cara"
                  }
                ],
                "correctOptionId": "b",
                "explanation": "'A piece of cake' significa algo moleza, muito simples."
              },
              {
                "id": "i2_5",
                "lessonId": "ing_adv",
                "questionNumber": 5,
                "totalQuestions": 10,
                "prompt": "What is the past form of the irregular verb 'Speak'?",
                "options": [
                  {
                    "id": "a",
                    "text": "Speaked"
                ...
                "correctOptionId": "b",
                "explanation": "Speak -> Spoke (past simple) -> Spoken (particípio)."
              },
              {
                "id": "i2_6",
                "lessonId": "ing_adv",
                "questionNumber": 6,
                "totalQuestions": 10,
                "prompt": "Which connector expresses contrast?",
                "options": [
                  {
                    "id": "a",
                    "text": "However"
                ...
                "correctOptionId": "a",
                "explanation": "'However' significa no entanto / contudo."
              },
              {
                "id": "i2_7",
                "lessonId": "ing_adv",
                "questionNumber": 7,
                "totalQuestions": 10,
                "prompt": "In 'She is looking forward to seeing you', what does 'look forward to' mean?",
                "options": [
                  {
                    "id": "a",
                  ...
                  {
                    "id": "b",
                    "text": "Aguardar com grande expectativa e alegria"
                  },
                  {
                    "id": "c",
                    "text": "Ignorar alguém"
                  ...
                  {
                    "id": "d",
                    "text": "Procurar óculos"
                  }
                ],
                "correctOptionId": "b",
                "explanation": "Significa esperar algo ansiosamente com entusiasmo."
              },
              {
                "id": "i2_8",
                "lessonId": "ing_adv",
                "questionNumber": 8,
                "totalQuestions": 10,
                "prompt": "Which modal verb indicates formal advice or obligation?",
                "options": [
                  {
                    "id": "a",
                    "text": "Might"
                ...
                "correctOptionId": "b",
                "explanation": "'Should' significa 'deveria' e é usado para recomendações e conselhos."
              },
              {
                "id": "i2_9",
                "lessonId": "ing_adv",
                "questionNumber": 9,
                "totalQuestions": 10,
                "prompt": "Complete: 'By the time we arrived, the movie _____ already started.'",
                "options": [
                  {
                    "id": "a",
                    "text": "has"
                ...
                "correctOptionId": "b",
                "explanation": "Past Perfect (had started) para uma ação anterior a outra no passado."
              },
              {
                "id": "i2_10",
                "lessonId": "ing_adv",
                "questionNumber": 10,
                "totalQuestions": 10,
                "prompt": "What does 'break the ice' mean in social situations?",
                "options": [
                  {
                    "id": "a",
                    "text": "Quebrar uma pedra de gelo"
                  },
                  {
                    "id": "b",
                    "text": "Iniciar uma conversa amigável para diminuir a timidez"
                  },
                  {
                    "id": "c",
                    "text": "Ficar resfriado"
                  },
                  {
                    "id": "d",
                    "text": "Dizer algo indelicado"
                  }
                ],
                "correctOptionId": "b",
                "explanation": "'Break the ice' é quebrar o gelo e iniciar uma interação descontraída."
              }
            ]
          }
        ]
